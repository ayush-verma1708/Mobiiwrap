...
// Redesigned TrendingProductCard component with minimalist black and white theme
function TrendingProductCard({ product, onAddToCart, onViewDetails }) {
  const isOnSale = product.originalPrice && product.originalPrice > product.price;
  const isNew = new Date(product.createdAt) > new Date(Date.now() - 14 * 24 * 60 * 60 * 1000);
  
  return (
    <div 
      className="group bg-black text-white border border-white/10 hover:border-white/30 transition-all duration-300 h-full cursor-pointer"
    ...
    >
      <div className="relative">
        ...
        <div className="absolute top-0 left-0 z-10">
          {isOnSale ? (
            <span className="inline-block bg-white text-black text-xs px-4 py-1 tracking-widest">
        ...
        {/* Product Image - Black background with white/light product image */}
      ...
      <div className="p-6">
        {/* Product Info */}
        <div className="mb-6">
          <div className="text-xs tracking-widest text-white/60 mb-2 uppercase">
            {product.productType?.name || "Product"}
          </div>
          
          <h3 className="text-base font-normal tracking-tight text-white mb-3 uppercase">
            {product.name}
          </h3>
          
          <div className="h-px w-8 bg-white/30 mb-3"></div>
        ...
        <div className="flex items-center justify-between border-t border-white/10 pt-4">
          ...
          <button 
            ...
            className="text-xs tracking-widest text-white/70 hover:text-white uppercase transition-colors duration-300"
          >
            Add
          </button>
        </div>
  ...
  return (
    <div className="bg-black text-white">
      <div className="sticky top-0 z-50">
        {/* Promo banner space - keeping it empty for now */}
      </div>
      ...
      <main>
        ...
        <section className="relative h-screen">
          <div className="absolute inset-0 bg-black">
            ...
            <div className="absolute bottom-0 right-0 w-full h-32 bg-white transform -skew-y-2 origin-bottom-right opacity-10" />
          </div>
          
          <div className="max-w-6xl mx-auto px-6 h-full flex items-center relative z-10">
            <div className="max-w-2xl">
              <span className="inline-block bg-white text-black px-6 py-2 text-xs tracking-widest mb-8 uppercase">New Collection</span>
              <h1 className="text-6xl md:text-8xl font-light tracking-tighter mb-8 uppercase">Elevate your device</h1>
              <div className="h-px w-12 bg-white mb-8"></div>
              <p className="text-lg opacity-80 mb-12 tracking-wide">
                Precision-cut skins for those who refuse to compromise on quality or style.
              </p>
              <div className="flex flex-col sm:flex-row gap-6">
                <Link to="/category/mobile-skins" className="group">
                  <span className="inline-block bg-white text-black px-12 py-4 text-xs tracking-widest hover:bg-white/90 transition-all duration-300 uppercase">
                    Shop Now
                  </span>
                </Link>
                <Link to="/category/mobile-skins" className="group">
                  <span className="inline-block border border-white px-12 py-4 text-xs tracking-widest hover:bg-white hover:text-black transition-all duration-300 uppercase">
                    Explore
                  </span>
                </Link>
              </div>
        ...
        {/* Trust Badges - Minimalist Treatment */}
        ...
        {/* Featured Collections - Minimalist Black & White */}
        <section className="py-24">
          <div className="max-w-6xl mx-auto px-6">
            <div className="mb-16">
              <div className="h-px w-12 bg-white mb-6"></div>
              <h2 className="text-4xl font-light tracking-tighter mb-4 uppercase">Collections</h2>
              <p className="text-white/70 max-w-2xl tracking-wide text-base">
                Precision-cut protection with premium finishes
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
              {featuredCollections.map((collection, index) => (
                ...
                >
                  <div className="relative h-96 md:h-[640px] overflow-hidden">
                    <img 
                    ...
                    <div className="absolute inset-0 flex items-end p-8">
                      <div>
                        <div className="h-px w-8 bg-white mb-4 transform transition-all duration-300 group-hover:w-16"></div>
                        <h3 className="text-xl font-light text-white mb-4 tracking-wide uppercase">{collection.name}</h3>
                        <span className="inline-block text-white text-xs tracking-widest uppercase opacity-0 transform translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300">
                          Explore
                        </span>
                      </div>
                    </div>
        ...
        {/* Flash Sale Section - Redesigned Minimalist */}
        <section className="py-24 bg-white text-black">
          <div className="max-w-6xl mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div className="flex flex-col justify-center">
                <span className="inline-block bg-black text-white px-6 py-2 text-xs tracking-widest mb-6 uppercase">Limited Time</span>
                <h2 className="text-5xl md:text-6xl font-light tracking-tighter mb-6 uppercase">
                  Up to 50% off
                </h2>
                <div className="h-px w-12 bg-black mb-6"></div>
                <p className="text-lg text-black/70 mb-8 tracking-wide">
                  Premium protection, exceptional value. Limited time offer.
                </p>
                
                <div className="mb-8">
                  <p className="text-black/60 text-sm mb-4 tracking-wide uppercase">Ends in:</p>
                  <CountdownTimer hours={23} minutes={59} seconds={59} />
                </div>
                
                <Link to="/category/mobile-skins" className="group">
                  <span className="inline-block bg-black text-white px-12 py-4 text-xs tracking-widest hover:bg-black/90 transition-all duration-300 uppercase">
                    Shop Now
                  </span>
                </Link>
              </div>
        ...
        {/* New Arrivals Section - Minimalist Black Theme */}
        <section className="py-24">
          <div className="max-w-6xl mx-auto px-6">
            <div className="flex flex-col md:flex-row justify-between items-start mb-16">
              <div>
                <div className="h-px w-12 bg-white mb-6"></div>
                <h2 className="text-4xl font-light tracking-tighter mb-4 uppercase">New Arrivals</h2>
                <p className="text-white/70 tracking-wide text-base">
                  The latest additions to our precision-cut collection
                </p>
              </div>
              <Link to="/category/mobile-skins" className="group mt-8 md:mt-0">
                <span className="text-white/80 hover:text-white text-xs tracking-widest uppercase transition-colors flex items-center">
                  View All
        ...
        {/* Trending Products - Minimalist White Theme */}
        <section className="py-24 bg-white text-black">
          <div className="max-w-6xl mx-auto px-6">
            <div className="mb-16">
              <div className="h-px w-12 bg-black mb-6"></div>
              <h2 className="text-4xl font-light tracking-tighter mb-4 uppercase">Trending Now</h2>
              <p className="text-black/70 tracking-wide text-base">
                Our most sought-after premium skins
              </p>
            </div>
            ...
            {isLoadingTrending ? (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2">
                {[...Array(4)].map((_, i) => (
                  <div key={i} className="bg-black/5 h-[400px] animate-pulse"></div>
                ))}
              </div>
            ) : (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2">
        ...
        {/* FAQ Section - Keep the existing one but ensure it follows black & white theme */}
        <FAQSection />
      </main>

      {/* Back to Top Button - Redesigned for Minimalist Theme */}
      <button
        className={`fixed right-8 bottom-8 bg-white text-black p-3 transition-opacity duration-300 ${
